...
public:
    ...
    explicit wxStringVisitor(wxWebViewChromium* webview, StringType type) : m_webview(webview), m_type(type) {}
                              ...
                              int httpStatusCode)
{
    ...
    if(frame->IsMain())
    {
        ...
        CefRefPtr<CefStringVisitor> source_visitor = new wxStringVisitor(
            m_webview, wxStringVisitor::StringType::PAGESOURCE);
        ...
        CefRefPtr<CefStringVisitor> text_visitor = new wxStringVisitor(
            m_webview, wxStringVisitor::StringType::PAGETEXT);
